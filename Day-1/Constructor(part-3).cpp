...
// Compiler form 2 types of Constructor in a class i.e, Default constructor and Copy Constructor.
...
class Complex{
    ...
    Complex(Complex &c){ // This is how we declare copy constructor.
        a = c.a;
        b = c.b;
    }
};
int main(){
    ...
    Complex c4 = c1; // or Complex c4(c1); // This will call Copy Constructor.
    return 0;
}
